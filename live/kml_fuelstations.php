...
$sql = "SELECT id, name, ST_X(geom) as lon, ST_Y(geom) as lat FROM nz_petrol_stations WHERE (box(point(" . $bbox_south . "," . $bbox_west . "),point(" . $bbox_east . "," . $bbox_north . ")) ~ (geom)) LIMIT 1000";
                //or with transform:
